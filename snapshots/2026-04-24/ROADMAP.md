...
- [ ] 2. PDF upload via file input + PDF.js rendering of the selected piece (paginated).
- [ ] 3. IndexedDB persistence: save uploaded PDFs and piece metadata; reload on app open.
