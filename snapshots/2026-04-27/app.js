...
const APP_VERSION = '0.5.0'; // roadmap item 5 — review rep counter
 ...
 * change (open, increment, undo, reset, IDB reconcile).
 */
function renderPracticePanel() {
  ...
  if (els.practiceStatus) {
    if (goalMet) {
      els.practiceStatus.textContent =
        `Nice — ${count} clean reps today. SRS scheduling lands in step 6.`;
